...
class Asset extends Depreciable
{
     ...
     * @return bool
     */
    public function checkOut($target, $admin = null, $checkout_at = null, $expected_checkin = null, $note = null, $name = null, $location = null, bool $signInPlace = false, ?string $filename = null)
    {
        if (! $target) {
            return false;
        }
        ...
        if ($this->save()) {
            ...
            event(new CheckoutableCheckedOut($this, $target, $checkedOutBy, $note, $originalValues, 1, $signInPlace, $filename));
